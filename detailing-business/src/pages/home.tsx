...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen  grid grid-cols-1 gap-10">
      {/* Hero Section */}
      ...
      {/* Services Section */}
      <section className="py-10 border rounded-lg bg-white">
      ...
      <section className="bg-white rounded-lg py-10 ">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            ...
            experienced professionals uses the latest techniques and products to
